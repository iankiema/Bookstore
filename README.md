...
# 📖 Awesome Bookstore <a name="about-project"></a>



**Awesome Bookstore** is a website that will enable the user to add,remove and save books to their local storage.
...
```sh
  cd my-folder
  git clone git@github.com:iankiema/Bookstore.git
```
...
I would like to thank Microverse for the overwhelming support and Faiz Mohammed my coding partner in this project.
